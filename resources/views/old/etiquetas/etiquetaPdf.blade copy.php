            ...
            <div class="etiqueta">
                ...
                <table width="100%">
                    <tbody class="etiqueta-body">
                        <tr class="tagReceived">
                            <td width="30%"><span>ARTICULOS:</span></td>
                            <td width="70%"><span>{{$etiqueta->descripcion}}</span></td>
                        </tr>
                    </tbody>
                </table>
                <div style="margin-top: -5px">
                    @if(Str::of($etiqueta->noblhouse)->limit(3) == 'ENA...')
                        <h5>EQUIPAJE NO ACOMPANADO</h5>

                        @elseif (Str::of($etiqueta->noblhouse)->limit(3) == 'MNJ...')
