                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" id="txtipocobro" name="txtipocobro" class="form-control form-control-sm txtipocobro" required disabled>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label><strong>{{ __("Importe") }}</strong></label>
                                        <input type="text" id="txtipocobroimporte" name="txtipocobroimporte" class="form-control form-control-sm txtipocobroimporte" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label><strong>{{ __("Fecha Inicio") }}</strong></label>
                                        <input id="txtfiniciotipocobro" class="form-control form-control-sm txtfiniciotipocobro" type="date" name="txtfiniciotipocobro" required disabled>
                                    </div>
                                    <div class="form-group col-sm-6">
