                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" id="txtnombre" name="txtnombre" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label for="lblapellidop"><strong>{{ __("Apellido Paterno") }}</strong></label>
                                        <input type="text" id="txtapellidop" name="txtapellidop" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label for="lblapellidom"><strong>{{ __("Apellido Materno") }}</strong></label>
                                        <input type="text" id="txtapellidom" name="txtapellidom" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        <label for="lbltelefono"><strong>{{ __("Telefono") }}</strong></label>
                                        <input type="text" id="txttelefono" name="txttelefono" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="lblnacionalidad"><strong>{{ __("Nacionalidad") }}</strong></label>
                                        <input type="text" id="txtnacionalidad" name="txtnacionalidad" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" id="txtcalle" name="txtcalle" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label for="lblnocalle"><strong>{{ __("No.") }}</strong></label>
                                        <input type="text" id="txtnocalle" name="txtnocalle" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                    <div class="form-group col-sm-3">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" id="txtentrecalle" name="txtentrecalle" class="form-control form-control-sm inputremdest" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="lblprov"><strong>{{ __("Provincia") }}</strong></label>
                                        <select id="txtprov"
                                                name="txtprov"
                                                class="selectpicker show-menu-arrow form-control form-control-sm inputremdest"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select id="txtmcpio" name="txtmcpio" class="selectpicker show-menu-arrow form-control form-control-sm inputremdest" data-live-search="true" required>

                                        </select>
                                    </div>
                                    <div class="form-group col-sm-3">
                                        <label for="lblcp"><strong>{{ __("Codigo Postal") }}</strong></label>
                                        <select id="txtcp" name="txtcp" class="selectpicker show-menu-arrow form-control form-control-sm inputremdest" data-live-search="true" required>
