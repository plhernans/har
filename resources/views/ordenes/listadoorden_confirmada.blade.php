            ...
            <div class="card-body col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12 col-xl-12 leftboxtOrdenesConfirmada m-auto p-0">
                    <div class="card mb-2">
                        <p></p>
                        <div>
                            <div class="form-inline col-sm-12 col-md-12 col-lg-12" style="height: 40px">
                                <label for="embconf" class="mr-1"><b>{{ __("Cargar embarque: ") }}</b></label>
                        ...
                        <table class="table table-hover table-bordered table-sm table-responsive-sm">
                            <thead class="thead-light">
                                <tr class="thead-light" style="height: 280px">
                                    <th style="text-align: center; vertical-align: middle"><button type="button" id="btnTransferOrden" class="btn btn-primary" disabled><i class="fa-solid fa-paper-plane"></i> Mover ordenes</button></th>
                                </tr>
                            </thead>
                        </table>
                    </div>
