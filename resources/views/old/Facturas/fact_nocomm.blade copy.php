...
<body>
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    <td colspan="3"><img src="assets/img/logo-goshima-transparente-395x300.png" height="180px"></td>
                    <td colspan="4" class="tdrigth" data-label="Compañ&iacute;a">
                        <b> Factura de Servicio x<br /></b>
                ...
                <tr>
                    <td colspan="3">
                        <h2>Factura</h2> <br /> <b>Clientes de Prueba </b>
                    </td>
