    ...
    <table>
        <thead>
            @foreach($data as $mfto)
                ...
                <tr>
                    <th class="cabeceraleft" style="width: 100px; height: 40px; font-weight: bold">Pais</th>
                ...
                <tr>
                    <th class="cabeceraleft" style="width: 100px; height: 40px; font-weight: bold">Contenedor No</th>
                    <th class="datosleft" style="width: 100px; height: 40px;" colspan="2">{{ $mfto->contenedor }}</th>
                    <th></th>
                    <th></th>
                    <th></th>
                    <th></th>
