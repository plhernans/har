                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" id="txtmproducto" name="txtmproducto" class="form-control form-control-sm txtmproducto requerido" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="lblmcapitulo"><strong>{{ __("Capitulo") }}</strong></label>
                                        <select id="txtmcapitulo"
                                                name="txtmcapitulo"
                                                class="selectpicker show-menu-arrow form-control form-control-sm txtmcapitulo requerido"
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select id="txtmarticulo"
                                                name="txtmarticulo"
                                                class="selectpicker show-menu-arrow form-control form-control-sm txtmarticulo requerido"
                                                data-live-search="true"
                                                required>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input id="txtfinicio" class="form-control form-control-sm txtfinicio requerido" type="date" name="txtfinicio" required>
                                    </div>
                                    <div class="form-group col-sm-6">
