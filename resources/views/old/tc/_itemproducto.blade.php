                    ...
                    <table id="tableItemProd" class="col-12 col-lg-12 table table-hover table-borderless table-sm table-responsive-sm tableItemProd">
                        <thead class="thead-light">
                            ...
                            <tr class="justify-content-between">
                                ...
                                <th scope="col" class="bg-light" hidden>{{ __("IdArticulo.") }}</th>
                        ...
                        <tbody id="tableItemProdBody">
                            @foreach($itemprod as $itemproditem)
                                <tr data-idarticulo="{{ $itemproditem->idarticulo }}" data-producto="{{ $itemproditem->producto }}" data-idcapitulo="{{ $itemproditem->idcapitulo }}" data-capitulo="{{ $itemproditem->capitulo }}" data-idcaparticulo="{{ $itemproditem->idcaparticulo }}" data-articulo="{{ $itemproditem->articulo }}" data-f_inicio="{{ $itemproditem->f_inicio }}" data-f_ffin="{{ $itemproditem->f_ffin }}">
                                    ...
                                    <td class="rowtditemprod" hidden>{{ $itemproditem->idcaparticulo }}</td>
