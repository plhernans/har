                                ...
                                <div class="row p-0">
                                    <div class="col-md-4 col-lg-4 m-0 p-0">
                                        ...
                                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <input type="text" id="txtimporte" name="txtimporte" class="selectpicker show-menu-arrow form-control form-control-sm" required>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                            <label for="lblctdad">{{ __("Cantidad") }}</label>
                                            <input type="text" id="txtctdad" name="txtctdad" class="selectpicker show-menu-arrow form-control form-control-sm" required disabled>
                                        </div>
                                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                            <label for="lbltotal">{{ __("Total") }}</label>
                                            <input type="text" id="txttotal" name="txttotal" class="selectpicker show-menu-arrow form-control form-control-sm" required disabled>
                                        </div>
                                        ...
                                        <div class="gridListaConceptoCargos col-md-12 col-lg-12" style="position: inherit">
                                            <table class="table table-hover table-bordered table-sm table-responsive-sm table_listaitemcargos">
                                                <thead class="thead-light">
                                                    <tr>
                                                        <th colspan="14"><button id="btnGeneraCargosAutomaticos" type="button" class="btn btn-sm btn-secondary btnEditar ml-auto"><i class="fas fa-cogs mr-1"></i>Generar cargos a cobrar</button></th>
                                                    </tr>
