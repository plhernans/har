                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12 col-xl-12 m-auto p-0">
                        <div class="card contenedor-mfactura">
                            <div class="card-header d-flex justify-content-between bg-primary text-white">
                                <h3 id="title-factura">{{ __('Facturacion')}}</h3>
                                ...
                                <div class="card-body col-sm-12 col-md-10 col-lg-10">
                                    <div class="form-row pt-2 mb-2 cardbodyfactura">
                                        <div class="form-group col-sm-2">
                                            ...
                                            <input type="text" id="txtblhousefactura" name="txtblhousefactura" class="form-control form-control-sm" disabled required>

                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label for="lblcliente">{{ __("Cliente") }}</label>
                                            <input id="txtclientefactura" name="txtclientefactura" class="form-control form-control-sm" disabled required>

                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label for="lbldirfactura">{{ __("Direccion") }}</label>
                                            <input type="text" id="txtdirfactura" name="txtdirfactura" class="form-control form-control-sm" disabled required>
                                        </div>
                                        <div class="form-group col-sm-2">
                                            <label for="lblteleffactura">{{ __("Telefono") }}</label>
                                            <input type="text" id="txttelffactura" name="txttelffactura" class="form-control form-control-sm" disabled required>
                                        </div>
                                        <div class="form-group col-sm-2">
                                    ...
                                    <div class="gridListaConceptoFactura">
                                        <div class="row p-0 m-0">
                                            <div class="col-sm-12 col-lg-3 col-md-3">
                                                <button type="button" id="btn-addCargoToFactura" class="btn btn-sm btn-primary mb-2 btnAceptar "><i class="fas fa-file" data-toggle="tooltip" title="Nueva Factura"></i></button>
                                                <button type="button" id="btnEditFactura" class="btn btn-sm btn-secondary mb-2 btnEditar" disabled><i class="fas fa-edit" data-toggle="tooltip" title="Editar Factura"></i></button>
                                                <button type="button" id="btnCancelFactura" class="btn btn-sm btn-secondary mb-2 btnEliminar" disabled><i class="fas fa-trash" data-toggle="tooltip" title="Eliminar Factura"></i></button>
                                            </div>
                                            <h5 class="col-sm-12 col-lg-4 col-md-4" id="etiqueta_estadoFac"><span id="festado" class="bg-secondary text-black-50">Factura: </span> <span id="festadovalor" class="bg-secondary text-black-50"></span> <span id="fcancelado" class="bg-secondary text-black-50"></span></h5>
                                            <h5 class="col-sm-12 col-lg-4 col-md-4" id="etiqueta_noFactura"><span class="bg-secondary text-black-50">No. </span> <span id="nofact" class="bg-primary text-white"></span></h5>
                                        </div>
