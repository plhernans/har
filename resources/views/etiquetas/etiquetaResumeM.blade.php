            ...
            <div class="etiqueta">
                ...
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <div style="width: 230px;">  {{-- style="padding: 0px; margin-bottom:0px" --}}
                            ...
                            <td>
                                <div style="width: 120px; padding: 0">
                                    <img style="width: 120px; margin-top:0" src="data:public/images/png;base64, {!! base64_encode(QrCode::format('png')->errorCorrection('H')->size(200)->generate($etiqueta->codigobarra)) !!} ">
                                    <h6 class="codigobarra cbtext" style="padding: 0px; margin-top:0px">{{$etiqueta->codigobarra}}</h6>
                                </div>
                            </td>
                        </tr>
                ...
                <div>
                    <img src="data:public/images/png;base64, {!! base64_encode(QrCode::format('png')->size(100)->generate($etiqueta->codigobarra)) !!} ">
                </div> --}}
                <br>
                @endforeach
            </div>
