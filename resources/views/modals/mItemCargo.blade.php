                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" id="txtmcargo" name="txtmcargo" class="form-control form-control-sm txtmcargo requerido" required>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label><strong>{{ __("Fecha Inicio") }}</strong></label>
                                        <input id="txtfiniciocargo" class="form-control form-control-sm txtfiniciocargo requerido" type="date" name="txtfiniciocargo" required>
                                    </div>
                                    <div class="form-group col-sm-6">
